...
std::string SubrangeFile::DebugStr() const {
    return fmt::format("SubrangeFile{{offset={}, size={}, base_file={}}}", file_offset, file_size,
                       *base_file);
}
...
ResultVal<u64> SubrangeFile::GetSize() const {
